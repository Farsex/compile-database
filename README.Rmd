...
Launch the [`make.R`](https://github.com/farsex/compiledatabase/tree/main/make.R)
file with:
...
check out our [Contributor Guidelines](https://github.com/farsex/compiledatabase/blob/main/CONTRIBUTING.md).
