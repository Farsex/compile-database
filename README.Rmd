...
Launch the [`make.R`](https://github.com/farsex/compile-database/tree/main/make.R)
file with:
...
check out our [Contributor Guidelines](https://github.com/farsex/compile-database/blob/main/CONTRIBUTING.md).
